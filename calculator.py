...
textDisplay = Entry(cal,font=('arial', 20, 'bold'), textvariable=text_input, bd =30, 
                    insertwidth = 4,bg= 'powder blue',justify='right').grid(columnspan = 5)
...
multiply=Button(cal,padx=16,bd=8,pady=16, fg='black',font=('ariel',20,'bold'),
...
subtraction=Button(cal,padx=16,pady=16,bd=8, fg='black',font=('arial',20,'bold'),
                   text='-', bg='powder blue',command=lambda:btnClick('_')) .grid(row=2,column=3)
...
btnEquals=Button(cal,padx=16,pady=16,bd=8, fg='black',font=('arial',20,'bold'),
                  text='=',bg='powder blue',command=btnEqualslnput) .grid(row=4,column=3)
...
Parentheses=Button(cal,padx=16,pady=16,bd=8, fg='black',font=('arial',20,'bold'),
                 text='()',bg='powder blue',command=lambda:btnClick('()')) .grid(row=5,column=2)

PlusMinus=Button(cal,padx=16,pady=16,bd=8, fg='black',font=('arial',20,'bold'),
                 text='+/_', bg='powder blue',command=lambda:btnClick('+/_')) .grid(row=5,column=3)
